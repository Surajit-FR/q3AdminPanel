    ...
    <>
      ...
      >
        ...
        <nav className="nav_bar_menu">
          ...
          <Link to="/customer-list" className={`nav-item ${location.pathname === '/customer-list'? 'active': ''}`}>
            <iconify-icon
          ...
          <Link to="/service-request-list" className={`nav-item ${location.pathname === '/service-request-list'? 'active': ''}`}>
            <iconify-icon
